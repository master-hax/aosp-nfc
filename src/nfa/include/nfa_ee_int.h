...
#ifndef NFA_EE_SYS_CODE_CFG_TAG_NAME
/* System Code                     */
#define NFA_EE_SYS_CODE_CFG_TAG_NAME 0x5F
#endif
...
typedef struct {
  /* default routing - technologies switch_on  */
  tNFA_TECHNOLOGY_MASK tech_switch_on;
  /* default routing - technologies switch_off */
  tNFA_TECHNOLOGY_MASK tech_switch_off;
  /* default routing - technologies battery_off */
  tNFA_TECHNOLOGY_MASK tech_battery_off;
  /* default routing - technologies screen_lock */
  tNFA_TECHNOLOGY_MASK tech_screen_lock;
  /* default routing - technologies screen_off */
  tNFA_TECHNOLOGY_MASK tech_screen_off;
  /* default routing - technologies screen_off_lock */
  tNFA_TECHNOLOGY_MASK tech_screen_off_lock;
  /* default routing - protocols switch_on */
  tNFA_PROTOCOL_MASK proto_switch_on;
  /* default routing - protocols switch_off */
  tNFA_PROTOCOL_MASK proto_switch_off;
  /* default routing - protocols battery_off */
  tNFA_PROTOCOL_MASK proto_battery_off;
  /* default routing - protocols screen_lock */
  tNFA_PROTOCOL_MASK proto_screen_lock;
  /* default routing - protocols screen_off  */
  tNFA_PROTOCOL_MASK proto_screen_off;
  tNFA_PROTOCOL_MASK
  ...
  uint8_t
      sys_code_cfg_entries; /* The number of SC entries in sys_code_cfg buffer*/
