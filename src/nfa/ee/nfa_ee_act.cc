...
void nfa_ee_api_clear_tech_cfg(tNFA_EE_MSG* p_data) {
  ...
  if ( p_data->clear_tech.technologies_switch_on   ||
       p_data->clear_tech.technologies_switch_off  ||
       p_data->clear_tech.technologies_battery_off ||
       p_data->clear_tech.technologies_screen_lock ||
       p_data->clear_tech.technologies_screen_off  ||
    ...
    p_cb->tech_screen_off_lock &= ~p_data->clear_tech.technologies_screen_off_lock;
...
void nfa_ee_api_clear_proto_cfg(tNFA_EE_MSG* p_data) {
  ...
  if ( p_data->clear_proto.protocols_switch_on   ||
       p_data->clear_proto.protocols_switch_off  ||
       p_data->clear_proto.protocols_battery_off ||
       p_data->clear_proto.protocols_screen_lock ||
       p_data->clear_proto.protocols_screen_off  ||
       p_data->clear_proto.protocols_screen_off_lock) {
