...
static bool rw_t4t_send_to_lower(NFC_HDR* p_c_apdu) {
  ...
  if (NFC_SendData(NFC_RF_CONN_ID, p_c_apdu) != NFC_STATUS_OK) {
    ALOGE("rw_t4t_send_to_lower (): NFC_SendData () failed");
    return false;
  }
...
static bool rw_t4t_get_hw_version(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_get_hw_version (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_get_sw_version(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_get_sw_version (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_get_uid_details(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_get_uid_details (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_create_app(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_create_app (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_select_app(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_select_app (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_create_ccfile(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_create_ccfile (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_create_ndef(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_create_ndef (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_write_cc(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_write_cc (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_write_ndef(void) {
  ...
  if (!p_c_apdu) {
    ALOGE("rw_t4t_write_ndef (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_select_file(uint16_t file_id) {
  ...
  ALOGD("rw_t4t_select_file (): File ID:0x%04X", file_id);

  p_c_apdu = (NFC_HDR*)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_c_apdu) {
    ALOGE("rw_t4t_select_file (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_read_file(uint16_t offset, uint16_t length,
  ...
  ALOGD("rw_t4t_read_file () offset:%d, length:%d, is_continue:%d, ", offset,
        length, is_continue);

  p_c_apdu = (NFC_HDR*)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_c_apdu) {
    ALOGE("rw_t4t_read_file (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_update_nlen(uint16_t ndef_len) {
  ...
  ALOGD("rw_t4t_update_nlen () NLEN:%d", ndef_len);

  p_c_apdu = (NFC_HDR*)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_c_apdu) {
    ALOGE("rw_t4t_update_nlen (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_update_file(void) {
  ...
  ALOGD("rw_t4t_update_file () rw_offset:%d, rw_length:%d", p_t4t->rw_offset,
        p_t4t->rw_length);

  p_c_apdu = (NFC_HDR*)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_c_apdu) {
    ALOGE("rw_t4t_write_file (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_update_cc_to_readonly(void) {
  ...
  ALOGD("rw_t4t_update_cc_to_readonly (): Remove Write access from CC");

  p_c_apdu = (NFC_HDR*)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_c_apdu) {
    ALOGE("rw_t4t_update_cc_to_readonly (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_select_application(uint8_t version) {
  ...
  ALOGD("rw_t4t_select_application () version:0x%X", version);

  p_c_apdu = (NFC_HDR*)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_c_apdu) {
    ALOGE("rw_t4t_select_application (): Cannot allocate buffer");
    return false;
  }
...
static bool rw_t4t_validate_cc_file(void) {
  ...
  ALOGD("rw_t4t_validate_cc_file ()");

  if (p_t4t->cc_file.cclen < T4T_CC_FILE_MIN_LEN) {
    ALOGE("rw_t4t_validate_cc_file (): CCLEN (%d) is too short",
          p_t4t->cc_file.cclen);
    return false;
  }
  ...
  if (p_t4t->cc_file.max_le < 0x000F) {
    ALOGE("rw_t4t_validate_cc_file (): MaxLe (%d) is too small",
          p_t4t->cc_file.max_le);
    return false;
  }

  if (p_t4t->cc_file.max_lc < 0x0001) {
    ALOGE("rw_t4t_validate_cc_file (): MaxLc (%d) is too small",
  ...
  if ((p_t4t->cc_file.ndef_fc.file_id == T4T_CC_FILE_ID) ||
    ...
    ALOGE("rw_t4t_validate_cc_file (): File ID (0x%04X) is invalid",
  ...
  if ((p_t4t->cc_file.ndef_fc.max_file_size < 0x0005) ||
    ...
    ALOGE("rw_t4t_validate_cc_file (): max_file_size (%d) is reserved",
          p_t4t->cc_file.ndef_fc.max_file_size);
    return false;
  }

  if (p_t4t->cc_file.ndef_fc.read_access != T4T_FC_READ_ACCESS) {
    ALOGE("rw_t4t_validate_cc_file (): Read Access (0x%02X) is invalid",
  ...
  if ((p_t4t->cc_file.ndef_fc.write_access != T4T_FC_WRITE_ACCESS) &&
    ...
    ALOGE("rw_t4t_validate_cc_file (): Write Access (0x%02X) is invalid",
...
#if (BT_TRACE_VERBOSE == TRUE)
  ALOGD("rw_t4t_sm_ndef_format (): sub_state:%s (%d)",
        rw_t4t_get_sub_state_name(p_t4t->sub_state).c_str(), p_t4t->sub_state);
#else
  ALOGD("rw_t4t_sm_ndef_format (): sub_state=%d", p_t4t->sub_state);
#endif
    ...
    case RW_T4T_SUBSTATE_WAIT_WRITE_NDEF:
      ...
      if (status_words != 0x9100) {
        ...
        if (rw_cb.p_cback) {
          ...
          ALOGD("rw_t4t_ndef_format (): Sent RW_T4T_NDEF_FORMAT_CPLT_EVT");
        }
      }
      break;

    default:
      ALOGE("rw_t4t_sm_ndef_format (): unknown sub_state=%d", p_t4t->sub_state);
      rw_t4t_handle_error(NFC_STATUS_FAILED, 0, 0);
      break;
  }
}
...
static void rw_t4t_sm_detect_ndef(NFC_HDR* p_r_apdu) {
...
#if (BT_TRACE_VERBOSE == TRUE)
  ALOGD("rw_t4t_sm_detect_ndef (): sub_state:%s (%d)",
        rw_t4t_get_sub_state_name(p_t4t->sub_state).c_str(), p_t4t->sub_state);
#else
  ALOGD("rw_t4t_sm_detect_ndef (): sub_state=%d", p_t4t->sub_state);
#endif
  ...
  if (status_words != T4T_RSP_CMD_CMPLTED) {
    ...
    if ((p_t4t->sub_state == RW_T4T_SUBSTATE_WAIT_SELECT_APP) &&
      ...
      ALOGD("rw_t4t_sm_detect_ndef (): retry with version=0x%02X",
            p_t4t->version);
  ...
  switch (p_t4t->sub_state) {
...
#if (BT_TRACE_VERBOSE == TRUE)
          ALOGD("Capability Container (CC) file");
          ALOGD("  CCLEN:  0x%04X", p_t4t->cc_file.cclen);
          ALOGD("  Version:0x%02X", p_t4t->cc_file.version);
          ALOGD("  MaxLe:  0x%04X", p_t4t->cc_file.max_le);
          ALOGD("  MaxLc:  0x%04X", p_t4t->cc_file.max_lc);
          ALOGD("  NDEF File Control TLV");
          ALOGD("    FileID:      0x%04X", p_t4t->cc_file.ndef_fc.file_id);
          ALOGD("    MaxFileSize: 0x%04X",
                p_t4t->cc_file.ndef_fc.max_file_size);
          ALOGD("    ReadAccess:  0x%02X", p_t4t->cc_file.ndef_fc.read_access);
          ALOGD("    WriteAccess: 0x%02X", p_t4t->cc_file.ndef_fc.write_access);
#endif
      ...
      if (p_r_apdu->len == T4T_FILE_LENGTH_SIZE + T4T_RSP_STATUS_WORDS_SIZE) {
        ...
        if (nlen <=
          ...
          if (rw_cb.p_cback) {
            ...
            ALOGD("rw_t4t_sm_detect_ndef (): Sent RW_T4T_NDEF_DETECT_EVT");
          }
        } else {
        ...
        ALOGE("rw_t4t_sm_detect_ndef (): Length (%d) of R-APDU must be %d",
    ...
    default:
      ALOGE("rw_t4t_sm_detect_ndef (): unknown sub_state=%d", p_t4t->sub_state);
      rw_t4t_handle_error(NFC_STATUS_FAILED, 0, 0);
      break;
  }
}
...
static void rw_t4t_sm_read_ndef(NFC_HDR* p_r_apdu) {
...
#if (BT_TRACE_VERBOSE == TRUE)
  ALOGD("rw_t4t_sm_read_ndef (): sub_state:%s (%d)",
        rw_t4t_get_sub_state_name(p_t4t->sub_state).c_str(), p_t4t->sub_state);
#else
  ALOGD("rw_t4t_sm_read_ndef (): sub_state=%d", p_t4t->sub_state);
#endif
  ...
  switch (p_t4t->sub_state) {
      ...
      if ((p_r_apdu->len > 0) && (p_r_apdu->len <= p_t4t->rw_length)) {
        ...
        if (rw_cb.p_cback) {
          ...
          if (p_t4t->rw_length > 0) {
            ...
            ALOGD("rw_t4t_sm_read_ndef (): Sent RW_T4T_NDEF_READ_CPLT_EVT");
          }
    ...
    default:
      ALOGE("rw_t4t_sm_read_ndef (): unknown sub_state = %d", p_t4t->sub_state);
      rw_t4t_handle_error(NFC_STATUS_FAILED, 0, 0);
      break;
  }
...
static void rw_t4t_sm_update_ndef(NFC_HDR* p_r_apdu) {
...
#if (BT_TRACE_VERBOSE == TRUE)
  ALOGD("rw_t4t_sm_update_ndef (): sub_state:%s (%d)",
        rw_t4t_get_sub_state_name(p_t4t->sub_state).c_str(), p_t4t->sub_state);
#else
  ALOGD("rw_t4t_sm_update_ndef (): sub_state=%d", p_t4t->sub_state);
#endif
  ...
  switch (p_t4t->sub_state) {
    case RW_T4T_SUBSTATE_WAIT_UPDATE_NLEN:
      ...
      if (p_t4t->p_update_data) {
        ...
        if (rw_cb.p_cback) {
          ...
          ALOGD("rw_t4t_sm_update_ndef (): Sent RW_T4T_NDEF_UPDATE_CPLT_EVT");
        }
      }
      break;
    ...
    default:
      ALOGE("rw_t4t_sm_update_ndef (): unknown sub_state = %d",
            p_t4t->sub_state);
      rw_t4t_handle_error(NFC_STATUS_FAILED, 0, 0);
      break;
  }
...
#if (BT_TRACE_VERBOSE == TRUE)
  ALOGD("rw_t4t_sm_set_readonly (): sub_state:%s (%d)",
        rw_t4t_get_sub_state_name(p_t4t->sub_state).c_str(), p_t4t->sub_state);
#else
  ALOGD("rw_t4t_sm_set_readonly (): sub_state=%d", p_t4t->sub_state);
#endif
  ...
  switch (p_t4t->sub_state) {
    ...
    case RW_T4T_SUBSTATE_WAIT_SELECT_NDEF_FILE:
      ...
      if (rw_cb.p_cback) {
        ...
        ALOGD("rw_t4t_sm_set_readonly (): Sent RW_T4T_SET_TO_RO_EVT");
        (*(rw_cb.p_cback))(RW_T4T_SET_TO_RO_EVT, &rw_data);
      }
      break;

    default:
      ALOGE("rw_t4t_sm_set_readonly (): unknown sub_state = %d",
            p_t4t->sub_state);
      rw_t4t_handle_error(NFC_STATUS_FAILED, 0, 0);
      break;
  }
...
void rw_t4t_process_timeout(TIMER_LIST_ENT* p_tle) {
  ALOGD("rw_t4t_process_timeout () event=%d", p_tle->event);

  if (p_tle->event == NFC_TTYPE_RW_T4T_RESPONSE) {
    rw_t4t_handle_error(NFC_STATUS_TIMEOUT, 0, 0);
  } else {
    ALOGE("rw_t4t_process_timeout () unknown event=%d", p_tle->event);
  }
}
...
void rw_t4t_handle_isodep_nak_rsp(uint8_t status, bool is_ntf) {
  tRW_DATA rw_data;
  tRW_T4T_CB* p_t4t = &rw_cb.tcb.t4t;
  ALOGD("rw_t4t_handle_isodep_nak_rsp %d", status);
...
static void rw_t4t_data_cback(uint8_t conn_id, tNFC_CONN_EVT event,
  ...
  ALOGD("rw_t4t_data_cback () event = 0x%X", event);
  nfc_stop_quick_timer(&p_t4t->timer);
...
#if (BT_TRACE_VERBOSE == TRUE)
  ALOGD("RW T4T state: <%s (%d)>", rw_t4t_get_state_name(p_t4t->state).c_str(),
        p_t4t->state);
#else
  ALOGD("RW T4T state: %d", p_t4t->state);
#endif
...
/* forward to upper layer without parsing */
    ...
    case RW_T4T_STATE_NDEF_FORMAT:
      ...
      break;
    default:
      ALOGE("rw_t4t_data_cback (): invalid state=%d", p_t4t->state);
      GKI_freebuf(p_r_apdu);
      break;
  }
  ...
  if (begin_state != p_t4t->state) {
    ALOGD("RW T4T state changed:<%s> -> <%s>",
...
tNFC_STATUS RW_T4tFormatNDef(void) {
  ALOGD("RW_T4tFormatNDef ()");

  if (rw_cb.tcb.t4t.state != RW_T4T_STATE_IDLE) {
    ALOGE("RW_T4tFormatNDef ():Unable to start command at state (0x%X)",
          rw_cb.tcb.t4t.state);
...
tNFC_STATUS RW_T4tDetectNDef(void) {
  ALOGD("RW_T4tDetectNDef ()");

  if (rw_cb.tcb.t4t.state != RW_T4T_STATE_IDLE) {
    ALOGE("RW_T4tDetectNDef ():Unable to start command at state (0x%X)",
          rw_cb.tcb.t4t.state);
    return NFC_STATUS_FAILED;
  }
...
tNFC_STATUS RW_T4tReadNDef(void) {
  ALOGD("RW_T4tReadNDef ()");

  if (rw_cb.tcb.t4t.state != RW_T4T_STATE_IDLE) {
    ALOGE("RW_T4tReadNDef ():Unable to start command at state (0x%X)",
          rw_cb.tcb.t4t.state);
    return NFC_STATUS_FAILED;
  }
  ...
  if (rw_cb.tcb.t4t.ndef_status & RW_T4T_NDEF_STATUS_NDEF_DETECTED) {
    ...
    ALOGE("RW_T4tReadNDef ():No NDEF detected");
    return NFC_STATUS_FAILED;
  }
}
...
tNFC_STATUS RW_T4tUpdateNDef(uint16_t length, uint8_t* p_data) {
  ALOGD("RW_T4tUpdateNDef () length:%d", length);

  if (rw_cb.tcb.t4t.state != RW_T4T_STATE_IDLE) {
    ALOGE("RW_T4tUpdateNDef ():Unable to start command at state (0x%X)",
          rw_cb.tcb.t4t.state);
    return NFC_STATUS_FAILED;
  }
  ...
  if (rw_cb.tcb.t4t.ndef_status & RW_T4T_NDEF_STATUS_NDEF_DETECTED) {
    ...
    if (rw_cb.tcb.t4t.ndef_status & RW_T4T_NDEF_STATUS_NDEF_READ_ONLY) {
      ALOGE("RW_T4tUpdateNDef ():NDEF is read-only");
      return NFC_STATUS_FAILED;
    }
    ...
    ALOGE("RW_T4tUpdateNDef ():No NDEF detected");
    return NFC_STATUS_FAILED;
  }
}
...
tNFC_STATUS RW_T4tPresenceCheck(uint8_t option) {
  ...
  ALOGD("RW_T4tPresenceCheck () %d", option);
...
tNFC_STATUS RW_T4tSetNDefReadOnly(void) {
  ...
  ALOGD("RW_T4tSetNDefReadOnly ()");

  if (rw_cb.tcb.t4t.state != RW_T4T_STATE_IDLE) {
    ALOGE("RW_T4tSetNDefReadOnly ():Unable to start command at state (0x%X)",
          rw_cb.tcb.t4t.state);
    return NFC_STATUS_FAILED;
  }
  ...
  if (rw_cb.tcb.t4t.ndef_status & RW_T4T_NDEF_STATUS_NDEF_DETECTED) {
    /* if read-only */
    if (rw_cb.tcb.t4t.ndef_status & RW_T4T_NDEF_STATUS_NDEF_READ_ONLY) {
      ALOGD("RW_T4tSetNDefReadOnly (): NDEF is already read-only");
    ...
    ALOGE("RW_T4tSetNDefReadOnly ():No NDEF detected");
    return NFC_STATUS_FAILED;
  }
  return (retval);
}
