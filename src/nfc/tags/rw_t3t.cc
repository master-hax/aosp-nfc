...
tNFC_STATUS RW_T3tPresenceCheck(void) {
  ...
  DLOG_IF(INFO, appl_trace_level >= BT_TRACE_LEVEL_DEBUG)
      << StringPrintf("RW_T3tPresenceCheck");
...
tNFC_STATUS RW_T3tGetSystemCodes(void) {
  ...
  DLOG_IF(INFO, appl_trace_level >= BT_TRACE_LEVEL_DEBUG)
      << StringPrintf("RW_T3tGetSystemCodes");
