...
#define NCI_DEACTIVATE_REASON_DH_REQ_FAILED \
  4 /* DH Request Failed due to error  */
...
#define NCI_DISCOVERY_TYPE_POLL_ACTIVE \
  0x03 /* NCI2.0 standardizes P2P poll active*/
...
#define NCI_DISCOVERY_TYPE_LISTEN_ACTIVE \
  0x83 /* NCI2.0 standardizes P2P listen active*/
