...
#define NCI_ROUTE_QUAL_LONG_SELECT \
  0x10 /* AID matching is allowed when the SELECT AID is longer */
#define NCI_ROUTE_QUAL_SHORT_SELECT \
  0x20 /* AID matching is allowed when the SELECT AID is shorter */
#define NCI_ROUTE_QUAL_BLOCK_ROUTE \
  0x40 /* AID is blocked in unsupported power mode */
